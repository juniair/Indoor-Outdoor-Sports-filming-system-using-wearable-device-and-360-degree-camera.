...
public class Caddy_Activity_index1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.caddy_activity_index1);

        Button button1 =(Button)findViewById(R.id.button_idx1);

//        Button button6 =(Button)findViewById(R.id.button6); //reset버튼
...
//                g.execute("http://192.168.0.26/moons/mobile/reset.php"+Caddy_Global.CaddyIdx);
